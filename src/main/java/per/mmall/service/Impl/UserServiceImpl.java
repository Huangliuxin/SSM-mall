...
import per.mmall.common.TokenCache;
import per.mmall.dao.UserMapper;
import per.mmall.pojo.User;
import per.mmall.service.IUserService;
import per.mmall.util.MD5Util;
...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse selectQuestion(String username){
        ...
        return ServerResponse.createByErrorMessage("找回密码的返回值是空的");
    }
    ...
    public ServerResponse<User> updateInformation(User user){
        ...
        int resultCount = userMapper.checkEmainByUserId(user.getEmail(),user.getId());
        if (resultCount>0){
